...
public  class User implements Serializable {  
    ...
    public User(int userId, String fullName, String Sex, Integer age, Integer phoneNumber, String Address,
                String title,String userName,String password,String Role) 
        throws Exception {
